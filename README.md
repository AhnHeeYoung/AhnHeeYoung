...
**Project (논문)**            |   CoNIC (Task : Cell Instance Segmentaiton, 논문 : [CLASS-CONTROLLING COPY–PASTE AUGMENTATION FOR NUCLEAR SEGMENTATION](https://github.com/AhnHeeYoung/Competition/blob/master/GrandChallenge-CoNIC/Paper/Paper%20edited.pdf), Challenge-Paper)
